...
#ifndef __ANGELJUICE_ANGELSCRIPTOPENGL_HEADER__
#define __ANGELJUICE_ANGELSCRIPTOPENGL_HEADER__

#include "juce.h"
#include "../../libraries/angelscript/angelscript.h"

//==============================================================================
/** Manages OpenGL functions in angel scripts

    @see AngelScriptEngine, OpenGL
*/
class asOpenGL
{
public:
...
#endif	// __ANGELJUICE_ANGELSCRIPTOPENGL_HEADER__
