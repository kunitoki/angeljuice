...
#include "AngelJuice_AngelScriptOpenGL.h"


//==============================================================================
void asOpenGL::registerObjectType(asIScriptEngine *engine)
{
	int r;

	r = engine->RegisterGlobalFunction("void glBegin(int)",                              asFUNCTION(glBegin), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glEnd()",                                   asFUNCTION(glEnd), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glEnable(int)",                             asFUNCTION(glEnable), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDisable(int)",                            asFUNCTION(glDisable), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glFinish()",                                asFUNCTION(glFinish), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glFlush()",                                 asFUNCTION(glFlush), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClear(int)",                              asFUNCTION(glClear), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glPointSize(float)",                        asFUNCTION(glPointSize), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLineStipple(int,int)",                    asFUNCTION(glLineStipple), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColor3f(float,float,float)",              asFUNCTION(glColor3f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColor3i(int,int,int)",                    asFUNCTION(glColor3i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColor4f(float,float,float,float)",        asFUNCTION(glColor4f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColor4i(int,int,int,int)",                asFUNCTION(glColor4i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColorMask(int,int,int,int)",              asFUNCTION(glColorMask), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLineStipple(int,int)",                    asFUNCTION(glLineStipple), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex2f(float,float)",                   asFUNCTION(glVertex2f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex3f(float,float,float)",             asFUNCTION(glVertex3f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex4f(float,float,float,float)",       asFUNCTION(glVertex4f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex2i(int,int)",                       asFUNCTION(glVertex2i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex3i(int,int,int)",                   asFUNCTION(glVertex3i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glVertex4i(int,int,int,int)",               asFUNCTION(glVertex4i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glNormal3f(float,float,float)",             asFUNCTION(glNormal3f), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glNormal3i(int,int,int)",                   asFUNCTION(glNormal3i), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glRectf(float,float,float,float)",          asFUNCTION(glRectf), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glRecti(int,int,int,int)",                  asFUNCTION(glRecti), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glFogf(int,float)",                         asFUNCTION(glFogf), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glFogi(int,int)",                           asFUNCTION(glFogi), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLightModelf(int,float)",                  asFUNCTION(glLightModelf), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLightModeli(int,int)",                    asFUNCTION(glLightModeli), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLightf(int,int,float)",                   asFUNCTION(glLightf), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glLighti(int,int,int)",                     asFUNCTION(glLighti), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glTranslatef(float,float,float,float)",     asFUNCTION(glTranslatef), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glRotatef(float,float,float,float)",        asFUNCTION(glRotatef), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glScalef(float,float,float)",               asFUNCTION(glScalef), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glAccum(uint,float)",                       asFUNCTION(glAccum), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glAlphaFunc(uint,float)",                   asFUNCTION(glAlphaFunc), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glArrayElement(int)",                       asFUNCTION(glArrayElement), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glBindTexture(uint,uint)",                  asFUNCTION(glBindTexture), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glBlendFunc(uint,uint)",                    asFUNCTION(glBlendFunc), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glCallList(uint)",                          asFUNCTION(glCallList), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClearAccum(float,float,float,float)",     asFUNCTION(glClearAccum), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClearColor(float,float,float,float)",     asFUNCTION(glClearColor), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClearDepth(double)",                      asFUNCTION(glClearDepth), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClearIndex(float)",                       asFUNCTION(glClearIndex), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glClearStencil(int)",                       asFUNCTION(glClearStencil), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glColorMaterial(uint,uint)",                asFUNCTION(glColorMaterial), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glCopyPixels(int,int,int,int,uint)",        asFUNCTION(glCopyPixels), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glCullFace(uint)",                          asFUNCTION(glCullFace), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDeleteLists(uint,int)",                   asFUNCTION(glCullFace), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDepthFunc(uint)",                         asFUNCTION(glDepthFunc), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDepthMask(bool)",                         asFUNCTION(glDepthMask), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDepthRange(double,double)",               asFUNCTION(glDepthRange), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDisableClientState(uint)",                asFUNCTION(glDisableClientState), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDrawArrays(uint,int,int)",                asFUNCTION(glDrawArrays), asCALL_CDECL); jassert(r >= 0);
	r = engine->RegisterGlobalFunction("void glDrawBuffer(uint)",                        asFUNCTION(glDrawBuffer), asCALL_CDECL); jassert(r >= 0);
}
