...
#ifndef __ANGELJUICE_ANGELSCRIPTCOMMON_HEADER__
#define __ANGELJUICE_ANGELSCRIPTCOMMON_HEADER__

#include "juce.h"

static uint32 dummy32bit = 0;
static void dummy_Constructor(void *obj) {}
static void dummy_Destructor(void *obj) {}
