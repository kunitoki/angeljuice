...
#ifndef __ANGELJUICE_PROJECTTREE_HEADER__
#define __ANGELJUICE_PROJECTTREE_HEADER__
...
//==============================================================================
class ProjectTreeView  : public Component
{
public:

    //==============================================================================
    ProjectTreeView (AngelJuiceComponent* holder);
    ~ProjectTreeView ();
