...
#ifndef __ANGELJUICE_STATUSBAR_HEADER__
#define __ANGELJUICE_STATUSBAR_HEADER__
...
public:
	...
	StatusBarComponent (AngelJuiceComponent* holder);
	~StatusBarComponent ();
...
#endif // __ANGELJUICE_STATUSBAR_HEADER__
